...
*Characters who search the walls for secret doors or otherwise inspect the panelling can, with a successful DC 12 Wisdom (Perception) check, see serpents and skulls inconspicuously woven into the wall designs.*

The decorative panelling follows the staircase as it circles upward to the second floor. A cloakroom (area 2B) has several black cloaks hanging from hooks on the walls. A top hat sits on a high shelf.



![[Session 1-1789552561459.webp|343x484]]
...
![[Session 1-1789553915375.webp|550x443]]


### Area 3

This oak-panelled room looks like a hunter’s den. Mounted above the fireplace is a stag’s head, and positioned around the outskirts of the room are three stuffed wolves

...
- Unfortunately he cant take them, but will give them enough horses


### Headless Horseman (CR 12)

- Occurs **1 day's ride from Caliphas** (or later if PCs use faster travel).
- If the PCs hide **Raven's Head** with magic (_nondetection_, _obscure object_, etc.), the encounter can be avoided or delayed.
- If delayed, it happens **before entering the Esoteric Vaults**.
